...
<html>
				...
				<?php foreach($roles as $role){?>
				     <tr>
				        ...
				        <td><?php echo $role->role_name; ?></td>
								<td>
									<button class="btn btn-warning" onclick="upd_role(<?php echo $role->id_role;?>)"><i class="glyphicon glyphicon-pencil"></i></button>
									<button class="btn btn-danger" onclick="del_role(<?php echo $role->id_role;?>)"><i class="glyphicon glyphicon-remove"></i></button>
  ...
  $(document).ready( function () {
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('index.php/role/add_role')?>";
      }
      else
      {
        url = "<?php echo site_url('index.php/role/upd_role')?>";
      }
