				...
				<?php foreach($users as $user){?>
				     <tr>
				        ...
				        <td><?php echo $user->username; ?></td>
								...
								<td>
									<button class="btn btn-warning" onclick="upd_user(<?php echo $user->id_user;?>)"><i class="glyphicon glyphicon-pencil"></i></button>
									<button class="btn btn-danger" onclick="del_user(<?php echo $user->id_user;?>)"><i class="glyphicon glyphicon-remove"></i></button>
